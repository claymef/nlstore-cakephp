...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'ab66462d20bf038c7ad872bb8eeaf68898b9e2c4b7e414da75597e3a34ccd91f'),
    ],
    ...
    'EmailTransport' => [
        ...
        'gmail' => [
            ...
            'port' => 465,
            'timeout' => 30,
            'username' => 'victorraulqq1@gmail.com',
            'password' => '01sistem',
            'client' => null,
            'tls' => null,
            'url' => env('EMAIL_TRANSPORT_DEFAULT_URL', null),
